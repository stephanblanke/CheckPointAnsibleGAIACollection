...
DOCUMENTATION = """
module: cp_gaia_alias_interfaces_facts
author: stephanblanke (@stephanblanke)
description:
- Show alias interfaces
...
EXAMPLES = """
- name: Show alias interfaces
  cp_gaia_alias_interfaces_facts:

- name: Show alias interface by specifying it name
  cp_gaia_alias_interfaces_facts:
    name: eth0.10
